...
class AppTextStyles {
  ...
  static TextStyle displayMedium = TextStyle(fontSize: 28.sp, fontWeight: FontWeight.w500, color: AppColors.textPrimary);

  static TextStyle displaySmall = TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w500, color: AppColors.textPrimary);

  // headings
  static TextStyle heading1 = TextStyle(fontSize: 28.sp, fontWeight: FontWeight.w500, color: AppColors.textPrimary);

  static TextStyle heading1Light = TextStyle(fontSize: 28.sp, fontWeight: FontWeight.w400, color: AppColors.textPrimary);
  ...
  static TextStyle bodyLargeMedium = TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w500, color: AppColors.textPrimary, height: 1.5);

  static TextStyle bodyMedium = TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w400, color: AppColors.textPrimary, height: 1.5);

  static TextStyle bodySmall = TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w400, color: AppColors.textSecondary, height: 1.5);

  // small labels
  static TextStyle labelLarge = TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w400, color: AppColors.textSecondary, height: 1.5);
  ...
  // Buttons
  static TextStyle buttonLarge = TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w600, color: Colors.white, letterSpacing: 0);
