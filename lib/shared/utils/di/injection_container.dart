...
Future<void> initializeDependencies() async {
  ...
  getIt.registerLazySingleton<HomeRemoteDataSource>(() => HomeRemoteDataSourceImpl(dioClient: getIt()));
  ...
  getIt.registerLazySingleton<CheckFirstTimeUseCase>(() => CheckFirstTimeUseCase(repository: getIt()));
  getIt.registerLazySingleton<CompleteOnboardingUseCase>(() => CompleteOnboardingUseCase(repository: getIt()));

  // Onboarding Feature - BLoC
  getIt.registerFactory<OnboardingBloc>(() => OnboardingBloc(completeOnboardingUseCase: getIt()));

  // Splash Feature - BLoC
  getIt.registerFactory<SplashBloc>(() => SplashBloc(storageService: getIt()));
